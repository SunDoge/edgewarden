...
<Card.Root>
  <Card.Header
    ><Card.Title>手动备份与恢复</Card.Title><Card.Description
      >下载加密备份包，或从已有备份恢复数据。</Card.Description
    ></Card.Header
  >
  <Card.Content
    ><Field.Group>
      ...
      <Field.FieldSet
        ><Field.FieldLegend>恢复选项</Field.FieldLegend><Field.FieldGroup
          ><Field.Field orientation="horizontal"
            ><Checkbox id="replace-existing" bind:checked={replaceExisting} /><Field.Label
              for="replace-existing">替换现有数据</Field.Label
            ></Field.Field
          ><Field.Field orientation="horizontal"
            ><Checkbox id="ignore-checksum" bind:checked={allowChecksumMismatch} /><Field.Label
              for="ignore-checksum">忽略校验和错误</Field.Label
            ></Field.Field
          ></Field.FieldGroup
        ></Field.FieldSet
      >
