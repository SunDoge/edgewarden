/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=../../wrangler.jsonc --env-interface=CloudflareBindings` (hash: 34d587c99554ea15e16545dd4c5d58bd)
...
interface __BaseEnv_CloudflareBindings {
	...
	REALTIME: DurableObjectNamespace<import("./src/index").VaultRealtime>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "VaultRealtime";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ATTACHMENT_STORAGE" | "SIGNUPS_ALLOWED" | "INVITATIONS_ALLOWED" | "JWT_SECRET" | "DATA_ENCRYPTION_SECRET" | "BOOTSTRAP_SECRET">> {}
}
